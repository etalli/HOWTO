...
Autoroutingをしようとしてこのエラーが出たときは、footprintで回路図と結びついていないものがあるときに出るので見つけて削除する。
見つけ方としてはすべてをグループにして、そのpropertyを見るとsymbolと結びついていないものが見つかるのでそれをすべて削除する。
一つでも残っていると自動配線の機能が使えない実装になっている。
